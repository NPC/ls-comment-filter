...
/**
 * Don't allow the browser to access this file directly
 */
if (!class_exists('Plugin')) {
	die('Hacking attempt!');
}

class PluginCommentfilter extends Plugin {

    // Объявление делегирований (нужны для того, чтобы назначить свои экшны и шаблоны)
	public $aDelegates = array(
		//'action' => array('ActionIndex'=>'ActionTimeline'),
		//'template' => array('index.tpl'=>'timeline.tpl'),
		//'template'=>array('actions/ActionIndex/index.tpl'=>'_actions/ActionTimeline/index.tpl')
            /*
	...
	public function Init() {
		...
		//$this->Viewer_AppendScript(Plugin::GetTemplatePath('PluginAbcplugin')."/js/javascript.js"); // Добавление своего JS
